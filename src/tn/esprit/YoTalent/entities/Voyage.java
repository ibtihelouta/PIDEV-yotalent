...
private int idVoy;
    ...
    public Voyage(String destination,String dateDVoy, String dateRVoy) {
    ...
    public Voyage(int idVoy, String dateDVoy, String dateRVoy, String destination) {
        this.idVoy = idVoy;
        this.dateDVoy = dateDVoy;
        this.dateRVoy = dateRVoy;
        this.destination = destination;
    ...
    public Voyage(String dateDVoy,String  dateRVoy, String destination,Contrat   idC) {
        this.dateDVoy = dateDVoy;
        this.dateRVoy = dateRVoy;
        this.destination = destination;
        this.idC = idC;
    ...
    public Voyage(int idVoy, String dateDVoy, String dateRVoy, String destination, Contrat  idC) {
        this.idVoy = idVoy;
        this.dateDVoy = dateDVoy;
        this.dateRVoy = dateRVoy;
        this.destination = destination;
