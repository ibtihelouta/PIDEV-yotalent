...
public class InterfaceParticFController implements Initializable {
    ...
    Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/YoTalent/GUI/InterfaceConsulterV.fxml"));
    ...
    private void GoToVote(ActionEvent event) throws IOException {
     Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/YoTalent/GUI/InterfaceVoteF.fxml"));
